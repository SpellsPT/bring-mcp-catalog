...
const expectedToolNames = [
  ...
  'loadTranslations',
  'loadCatalog',
  // Catalog and item-detail tools. bringApiRaw is deliberately absent: it is
  // only registered when BRING_MCP_RAW=1.
  'findCatalogItem',
  'findCatalogSection',
  'saveItemResolved',
  'setItemIcon',
...
describe('MCP Bring! server integration', () => {
  ...
  it('registers exactly 26 fully described tools', async () => {
    await loadServer();
