...
export const mockFindCatalogItem = jest.fn() as AsyncMock;
export const mockFindCatalogSection = jest.fn() as AsyncMock;
export const mockSaveItemResolved = jest.fn() as AsyncMock;
export const mockSetItemIcon = jest.fn() as AsyncMock;
export const mockSetItemSection = jest.fn() as AsyncMock;
export const mockRemoveItemDetail = jest.fn() as AsyncMock;
export const mockDescribeItemDetails = jest.fn() as AsyncMock;
export const mockBatchUpdateList = jest.fn() as AsyncMock;
export const mockRenameItem = jest.fn() as AsyncMock;
export const mockSetListArticleLanguage = jest.fn() as AsyncMock;
export const mockApiRaw = jest.fn() as AsyncMock;
