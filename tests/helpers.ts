...
export let mockFindCatalogItem: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockFindCatalogSection: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockSaveItemResolved: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockSetItemIcon: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockSetItemSection: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockRemoveItemDetail: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockDescribeItemDetails: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockBatchUpdateList: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockRenameItem: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockSetListArticleLanguage: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
export let mockApiRaw: jest.MockedFunction<(...args: unknown[]) => Promise<unknown>>;
...
jest.mock('../src/bringClient.js', () => {
  ...
  mockFindCatalogItem = jest.fn();
  mockFindCatalogSection = jest.fn();
  mockSaveItemResolved = jest.fn();
  mockSetItemIcon = jest.fn();
  mockSetItemSection = jest.fn();
  mockRemoveItemDetail = jest.fn();
  mockDescribeItemDetails = jest.fn();
  mockBatchUpdateList = jest.fn();
  mockRenameItem = jest.fn();
  mockSetListArticleLanguage = jest.fn();
  mockApiRaw = jest.fn();
  ...
  return {
    BringClient: jest.fn().mockImplementation(() => ({
      ...
      findCatalogItem: mockFindCatalogItem,
      findCatalogSection: mockFindCatalogSection,
      saveItemResolved: mockSaveItemResolved,
      setItemIcon: mockSetItemIcon,
      setItemSection: mockSetItemSection,
      removeItemDetail: mockRemoveItemDetail,
      describeItemDetails: mockDescribeItemDetails,
      batchUpdateList: mockBatchUpdateList,
      renameItem: mockRenameItem,
      setListArticleLanguage: mockSetListArticleLanguage,
      apiRaw: mockApiRaw,
    })),
    connect: jest.fn(),
